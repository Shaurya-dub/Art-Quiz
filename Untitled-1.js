...
const questionBank = [
     {
        ...
        backgrounds: {
            wAnsOne:'url("media/starry-night-by-vincent-van-gogh-vincent-van-gogh.jpg")',
    ...
    {
        question: 'The period between 1901 - 1904 when Pablo Picasso painted mainly monochromatic paintings ',
        answers: {
        ...
        hint: 'It is named after a color he used a lot'
    },
    {
        ...
        hint: 'They probably wont be able to put on a pair of glasses'
    },
    {
        question: 'One of the most famous works by this artist is a painting of a soup can',
        answers: {
        rAns: 'Andy Warhol',
        wAnsOne: 'Frida Kahlo',
        wAnsTwo: 'Kara Walker',
    ...
    {
        question: 'This artist from 1980s NY is known for his vibrant, eye-catching pieces grounded in street culture',
        answers: {
        rAns: 'Keith Haring',
        wAnsOne: 'Basquiat',
        ...
        hint: 'They would do a lot of "subway drawings" using chalk'
        
    }, 
    {
        question: 'Which Japanese artist is the founder of the "SuperFlat" movement?',
        answers: {
        wAnsOne: 'Ogata Kōrin',
    ...
    {
        question: 'This character created by American artist "KAWS" is considered a "subculture hero',
        answers: {
        wAnsOne: 'Liquid Hal',
        rAns: 'Companion',
        wAnsTwo: 'Wimpus',
    ...
    {
        question: 'This insanely popular American designer founded the brand "Off-White',
        answers: {
        rAns: 'Virgil Abloh',
        wAnsOne: 'Kanye West',
        wAnsTwo: 'Rammelzee',
        ...
        hint: "He is the first African American artistic director at Louis Vuitton" 
        
    },
    {
        question: 'The proteges of this wildly influential tattoo artist include the likes of "Ed Hardy',
        answers: {
        wAnsOne: 'Kat Von D',
        wAnsTwo: 'Mike Malone',
        wAnsThree: 'Zeke Owen',
    ...
    {
        question: 'The real identity of this enigmatic graffiti artist is still not 100% confirmed',
        answers: {
        wAnsOne: 'DONDI',
        rAns: 'Banksy',
        wAnsTwo: 'SEEN',
...
$start.on('click', function(e){
    ...
    $clue.text(questionBank[qCount].hint)
            ...
            for ( let opt in questionBank[qCount].answers) {
                ...
                $buttons.eq(j).css('background-image',  questionBank[qCount].backgrounds[opt])
                j++
...
for (let button of $buttons) {
    ...
    button.addEventListener('click', function(e) {
        ...
        if(qCount < questionBank.length - 1) {
            ...
            $h2.text(questionBank[qCount].question)
            console.log(qCount)
            console.log(questionBank[qCount])
            let j = 0;
            for ( let opt in questionBank[qCount].answers) {
